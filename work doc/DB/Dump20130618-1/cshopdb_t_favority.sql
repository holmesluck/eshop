...
CREATE TABLE `t_favority` (
  ...
  CONSTRAINT `fk_favority_user` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `t_favority` VALUES (1,1),(2,2);
...
-- Dump completed on 2013-06-18 11:17:40
