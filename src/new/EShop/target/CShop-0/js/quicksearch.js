/*quicksearch.js是关于高级搜索页面使用的按钮点击的事件操作 by 张羊左
*/
$(document).ready(function () {
 ...
 //按销量排序的按钮的事件操作
   $("#sales").bind("click",function(){
	       ...
	       var result1=document.getElementById("hwd-quickSearch");
	       searchWords=result1.value;
	       if(state!="no"){
	    	   state="no";
	       }
	       else{
	       ...
	       $("#sales").attr("href","quickSearchGoods.action?searchWords="+searchWords+"&priceSort=no&page=0&soldSort="+state);
	        return true;
   }); 
//价格排序的按钮的时间操作
   $("#price").bind("click",function(){
	   ...
	   $("#price").attr("href","quickSearchGoods.action?searchWords="+searchWords+"&priceSort="+state1+"&page=0&soldSort=no");
       return true;
   });
//快速搜索页面的更多事件按钮
